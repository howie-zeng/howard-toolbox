...
def main():
    ...
    parser.add_argument("--dial", type=str, default=None,
                        help="Dial file name under input/dial/<name>.txt (transition-rate multipliers)")
    ...
    dial_name = args.dial or config.get("dial_name", "")
